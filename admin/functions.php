...
if($filename[1] == 'csv'){
    ...
    
    {
      ...
      $query = "INSERT into tbl_user (user_id, firstName, lastName, email, password) 
      values('$item1','$item2','$item3','$item4','$item5')
      ON DUPLICATE KEY UPDATE firstName='$item2', lastName='$item3', email='$item4', password='$item5'";
...
fclose($handle);
header("location:../admin/user-table.php?error=Uploaded");
     exit;
