...
if($filename[1] == 'csv'){
    ...
    
    {
      ...
      $query = "INSERT INTO student (s_id, s_name, s_bdate, s_gender, s_address, s_status, s_pass) 
      VALUES('$item1','$item2','$item3','$item4','$item5', '$item6', '$item7')
      ON DUPLICATE KEY UPDATE s_name='$item2', s_bdate='$item3', s_gender='$item4', s_address='$item5', s_status='$item6', s_pass='$item7'";
...
fclose($handle);
header("location:../admin/student-table.php?error=Uploaded");
     exit;
