...
include("../modals/st_uploadmodal.php");
...
<?php	
  ...
  $sql = 'SELECT * FROM tbl_students WHERE s_name LIKE :keyword OR s_id LIKE :keyword OR s_email LIKE :keyword ORDER BY s_id ASC ';
...
<form name='frmSearch' action='' method='post'>
  ...
  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#st_uplodaModal" style=" margin-bottom: 15px; "> Upload </button>
