<div class="modal fade" id="uplodaModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form action="../admin/functions.php" method="post" name="file" enctype="multipart/form-data">
